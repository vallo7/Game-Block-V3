/*
  ui/tutorial.js
  --------------------------------------------------------------------
  Tutoriel de première ouverture. Portage à l'identique de l'ancien
  js/tutorial.js. Importe Game depuis core/game-state.js (et non le
  barrel core/game.js) pour éviter un cycle d'import inutile ; les
  méthodes utilisées ici (chooseObstacleCells, spawnParticles,
  getCellSize...) sont ajoutées à ce même objet Game par les autres
  fichiers core/game-*.js au chargement de l'app.
  --------------------------------------------------------------------
*/
