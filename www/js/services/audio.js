...
export const GameAudio = {
  ...
  // Fanfare de félicitation dédiée au déblocage d'un trophée (roadmap
  // Phase 5, demande explicite) : carillon ascendant à 5 notes (un ton
  // au-dessus de celui de playTutorialDone, pour rester reconnaissable
  // comme un événement distinct) suivi de deux éclats aigus superposés —
  // jouée par ui/trophies.js#showRevealQueue à chaque carte de révélation.
  playTrophyUnlock() {
    const base = 587;
  ...
  // Petit son de collecte, joué au moment précis où le joueur réclame la
  // récompense d'un trophée (bouton "Claim", ui/trophies.js) — distinct de
  // playTrophyUnlock() (la fanfare jouée à l'apparition de la carte) : un
  // tintement de pièces bref et satisfaisant plutôt qu'un carillon complet.
  playCoinClaim() {
    this.playTone(1050, { duration: 0.07, type: "sine", gain: 0.3, slideTo: 1400 });
    this.playTone(1400, { duration: 0.08, type: "triangle", gain: 0.22, delay: 0.05, slideTo: 1800 });
  }
};
