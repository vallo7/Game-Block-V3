...
Object.assign(Game, {
  ...
  validate() {
    ...
    if (emptied) {
      ...
      // Filière 2 de déblocage d'Halloween (roadmap §3.3) : Perfect
      // Clear x3 dans la même partie Classic. Sans effet une fois
      ...
      if (this.perfectClearsThisRun >= 3) {
        if (VisualTheme.unlockThemeByCondition("halloween")) {
