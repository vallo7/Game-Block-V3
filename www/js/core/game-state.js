/*
  ...
  `gridImages`, consommé par core/game-render.js#drawBoard(). Le champ
  `contentBoundsCache` (également consommé par game-render.js) met en
  cache, par URL d'image, la zone réellement opaque de chaque asset de
  grille — nécessaire pour que les cases s'alignent pile avec la grille
  logique quelle que soit la marge éventuellement présente dans le
  fichier source (correctif alignement grille).
  --------------------------------------------------------------------
*/
