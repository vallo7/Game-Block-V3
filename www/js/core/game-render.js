/*
  core/game-render.js
  --------------------------------------------------------------------
  Tout le rendu Canvas : grille (avec cache hors-écran), cases et leurs
  animations (spawn/place/validate/destroy), particules/débris,
  faisceaux de ligne, praise/combo FX, et les utilitaires géométrie /
  couleur qui leur sont propres.
  --------------------------------------------------------------------
*/
